...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FullPathOverride) DeepCopyInto(out *FullPathOverride) {
	*out = *in
	if in.Prefix != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FullPathOverride.
func (in *FullPathOverride) DeepCopy() *FullPathOverride {
	if in == nil {
		return nil
	}
	out := new(FullPathOverride)
	in.DeepCopyInto(out)
	return out
}
