...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenRouterConfig) DeepCopyInto(out *OpenRouterConfig) {
	*out = *in
	in.AuthToken.DeepCopyInto(&out.AuthToken)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenRouterConfig.
func (in *OpenRouterConfig) DeepCopy() *OpenRouterConfig {
	if in == nil {
		return nil
	}
	out := new(OpenRouterConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SupportedLLMProvider) DeepCopyInto(out *SupportedLLMProvider) {
	*out = *in
	...
	if in.OpenRouter != nil {
		in, out := &in.OpenRouter, &out.OpenRouter
		*out = new(OpenRouterConfig)
		(*in).DeepCopyInto(*out)
	}
}
