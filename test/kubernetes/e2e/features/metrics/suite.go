	...
	s.TestInstallation.Assertions.AssertEventualCurlResponse(
		...
		&testmatchers.HttpResponse{
			...
			Body: gomega.And(
				...
				gomega.MatchRegexp(`kgateway_resources_syncs_started_total\{gateway=\"gw2\",namespace=\"default\",resource=\"Gateway\"} [2-5]`),
				gomega.MatchRegexp(`kgateway_resources_syncs_started_total\{gateway=\"gw2\",namespace=\"default\",resource=\"HTTPRoute\"} [1-2]`),
				gomega.MatchRegexp(`kgateway_resources_status_syncs_completed_total\{gateway=\"gw2\",namespace=\"default\",resource=\"Gateway\"} [2-5]`),
				gomega.MatchRegexp(`kgateway_resources_status_syncs_completed_total\{gateway=\"gw2\",namespace=\"default\",resource=\"HTTPRoute\"} [1-2]`),
				gomega.MatchRegexp(`kgateway_resources_status_sync_duration_seconds_count\{gateway=\"gw2\",namespace=\"default\",resource=\"Gateway\"} [2-5]`),
				gomega.MatchRegexp(`kgateway_resources_status_sync_duration_seconds_count\{gateway=\"gw2\",namespace=\"default\",resource=\"HTTPRoute\"} [1-2]`),
				...
				gomega.MatchRegexp(`kgateway_translator_translation_duration_seconds_count\{translator=\"TranslateHTTPRoute\"\} \d+`),
				gomega.MatchRegexp(`kgateway_translator_translations_total\{result=\"success\",translator=\"TranslateHTTPRoute\"\} \d+`),
